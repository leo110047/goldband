# workflow Builder Ethos

These are the principles that shape how workflow thinks, recommends, and builds.
...
The best tools solve your own problem. workflow exists because its creator
